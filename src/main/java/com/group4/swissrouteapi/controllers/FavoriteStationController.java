...
public class FavoriteStationController {
    ...
    public ResponseEntity<StationResponse> addFavoriteStations(
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(favoriteStationService.addFavoriteStation(
    ...
    public ResponseEntity<FavStationsResponse> getFavoriteStations(Authentication authentication) {
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(favoriteStationService.getFavoriteStation(
                        UUID.fromString(authentication.getName())));
    }
    ...
    @ApiResponses({
            @ApiResponse(
                    responseCode = "204",
                    description = "Favorite station deleted successfully."),
            @ApiResponse(
                    responseCode = "400",
    ...
    public ResponseEntity<Void> deleteFavoriteStations(
            Authentication authentication,
            @PathVariable String externalStationId) {
