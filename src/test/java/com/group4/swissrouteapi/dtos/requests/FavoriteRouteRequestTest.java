...
class FavoriteRouteRequestTest {
    ...
    class BuilderTests {
        ...
        void builder_producesIndependentInstances() {
            FavoriteRouteRequest a = FavoriteRouteRequest.builder()
                    .name("A").origin("X").destination("Y").build();
            FavoriteRouteRequest b = FavoriteRouteRequest.builder()
                    .name("B").origin("X").destination("Y").build();
