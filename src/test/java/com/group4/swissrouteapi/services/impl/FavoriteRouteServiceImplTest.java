...
class FavoriteRouteServiceImplTest {
    ...
    private FavoriteRouteResponse buildResponse(FavoriteRouteEntity entity) {
    ...
    class AddFavoriteRouteSuccess {
        ...
        void returnsMappedResponse_producedByMapper() {
            ...
            FavoriteRouteResponse expectedResponse = buildResponse(entity);
            ...
            FavoriteRouteResponse result = favoriteRouteService.addFavoriteRoute(USER_ID, request);
        ...
        void delegatesToProcessor_withResolvedUserAndAllRequestFields() {
            ...
            verify(favoriteRouteProcessor).saveFavoriteRoute(
                    user,
                    request.getName(),
                    request.getOrigin(),
                    request.getDestination(),
        ...
        void passesRequestFields_toProcessor_withoutModification() {
            UserEntity user = buildUser();
            FavoriteRouteRequest request = FavoriteRouteRequest.builder()
                    .name("Night Ship")
                    .origin("Geneva")
                    .destination("Lucerne")
