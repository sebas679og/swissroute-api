 ...
 *
 * <p>Verifies that {@code saveSearchHistory} correctly looks up the user, builds
 * the {@link SearchHistoryEntity} with all provided fields, delegates persistence
 * to the repository, and throws {@link NotFoundException} when the user does not exist.
 */
